      ...
      <div className="wrap1">
        ...
        >
          ...
          <div>
            ...
            устройств. Используется для инструктажей, наглядной демонстрации и
            анализа оперативных переключений.
            <h3>Назначение кнопок:</h3>
            <ul>
              <li>
                Кнопка "Схема РП" - при нажатии отображает схему, в которой все
                элементы отключены.
              </li>
              <li>
                Кнопка "Нормальная схема РП" (загружается по
                умолчанию) - отображает схему со всеми включёнными и
                отключенными элементами согласно нормальному режиму работы
                установки.
              </li>
            </ul>
          </div>
